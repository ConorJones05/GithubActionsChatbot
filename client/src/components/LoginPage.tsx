...
function LoginPage() {
  ...
  const handleGithubLogin = async () => {
    try {
      ...
      console.log("Auth redirect initiated:", data);
  ...
  return (
    <div className="login-container">
      <div className="login-card">
        <h1 className="login-title">GitHub Actions Chatbot</h1>
        ...
        >
          {loading ? (
            ...
            <span>
              <svg className="github-icon" viewBox="0 0 20 20" fill="currentColor">
